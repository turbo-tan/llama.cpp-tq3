...
#if defined(__APPLE__) && defined(GGML_USE_WEBGPU)
    // Apple WebGPU currently aborts while uploading the cumsum test tensors.
    // Keep the rest of the backend-op matrix intact and skip only this family.
#else
