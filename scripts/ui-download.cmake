...
if(PROVISION_SUCCESS)
    ...
    foreach(asset ${ASSETS})
        if(NOT EXISTS "${PUBLIC_DIR}/${asset}")
            ...
            if("${asset_ext}" STREQUAL ".html")
                file(WRITE "${PUBLIC_DIR}/${asset}" "<!doctype html><title>UI unavailable</title>")
            elseif("${asset_ext}" STREQUAL ".js")
                file(WRITE "${PUBLIC_DIR}/${asset}" "/* UI unavailable */\n")
            elseif("${asset_ext}" STREQUAL ".css")
                file(WRITE "${PUBLIC_DIR}/${asset}" "/* UI unavailable */\n")
            else()
                file(WRITE "${PUBLIC_DIR}/${asset}" "")
            endif()
        endif()
    endforeach()
